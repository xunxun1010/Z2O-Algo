...
2.[4/5 SR3R: Rethinking Super-Resolution 3D Reconstruction With Feed-Forward Models](./note/3drec/sr3r.md)
### 2.图像增强
...
### 3.3cli
1.[cli参考手册](https://github.com/xunxun1010/Z2O-Algo/blob/main/note/tool/CLI.md)
### 4.codex
1.[配置文件]()
